...
import java.awt
import skitch.core.{SkitchApp, Tex, Java, Resource}
import skitch.{common, Color, gl}
import skitch.vector.{vec2, vec}
import java.io.{File, FileInputStream}


class Font(path:String, size:Int, style:Font.Style.Plain.type = Font.Style.Plain)(implicit app:SkitchApp) {
	...
	//TODO: offsets
	def drawString(what:String, pos:vec2, anchor:vec2=anchor, scale:Float=1f) {
		skitch.gl.fill(true)
